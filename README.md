...
This repo contains many popular algorithms (based on common data structures and algorithms) written in JavaScript. There's (less) organised repo (master) if you want to refer problem randomly.
