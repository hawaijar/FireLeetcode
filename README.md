...
This repo (wip) (will)contains many popular algorithms (based on common data structures and algorithms) written in JavaScript, Swift and Kotlin. There's also a (less)organised repo (master) if you want to refer problems randomly.
